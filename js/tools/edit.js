...
App.register('edit', {
    ...
    async renderPage(num) {
        ...
        if (cw === 0) {
            ...
            cw = canvas.offsetHeight;
            cw = canvas.offsetWidth;
        }
        this._canvasScaleInternal = cw / canvas.width;
        if (!this._canvasScaleInternal || this._canvasScaleInternal <= 0 || !isFinite(this._canvasScaleInternal)) {
            this._canvasScaleInternal = 1;
        }
        this._canvasScale = this._canvasScaleInternal;
    ...
    _applyZoom() {
        ...
        this._canvasScale = (canvas.offsetWidth / canvas.width) || 1;
    },
